        ...
        <div class="con_right">
            ...
            <div class="box_4">
                <div class="page">
                    ...
                    <span id="first_page">首页</span><a  class='current'>1</a><span id="last_page">尾页</span>
                    <span id="next_page" class='next'>下一页</span>
                    <div>共<span id="pageCount"></span>页 到第<input class="page_txt" type="text" />页 <input type="button" id="skipPage" value="确定" /></div>
                </div>
            </div>
        </div>
    </div>
